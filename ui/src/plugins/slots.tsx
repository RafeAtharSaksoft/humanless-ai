...
function createReactShimSource(reactModule: object): string {
  ...
  return `
        ...
        if (!R) {
          throw new Error("Humanless AI plugin React runtime is not initialized.");
        }
        export default R;
${namedExports}
      `;
    ...
    case "sdk-ui":
      source = `
        ...
        function missing(name) {
          return function MissingHumanlessSdkUiComponent() {
            throw new Error('Humanless AI plugin UI runtime is not initialized for "' + name + '". Ensure the host loaded the plugin bridge before rendering this UI module.');
          };
        }
