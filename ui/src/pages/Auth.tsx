...
export function AuthPage() {
  ...
  return (
    <div className="fixed inset-0 flex bg-background">
      {/* Left half — indigo gradient branding panel (hidden on mobile) */}
      <div className="hidden md:flex md:w-1/2 flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-indigo-600 via-indigo-700 to-indigo-900">
        ...
        <div className="relative z-10 flex flex-col items-center gap-6 px-8">
          ...
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-lg">
            <rect x="8" y="6" width="6" height="52" rx="2" fill="white" />
            <rect x="50" y="6" width="6" height="52" rx="2" fill="white" />
            <rect x="14" y="29" width="36" height="6" rx="2" fill="white" />
          </svg>
          <div className="text-center">
            <h2 className="text-3xl font-bold text-white tracking-tight">Humanless AI</h2>
            <p className="mt-1.5 text-indigo-200 text-sm font-medium">by Saksoft</p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md mx-auto my-auto px-8 py-12">
          <div className="flex items-center gap-2 mb-8">
            ...
            <div>
              ...
              <span className="text-xs text-muted-foreground ml-1.5">by Saksoft</span>
            </div>
          </div>

          <h1 className="text-xl font-semibold">
            {mode === "sign_in" ? "Sign in to Humanless AI" : "Create your Humanless AI account"}
          </h1>
          ...
          >
            ...
            <Button
              ...
              className={`w-full bg-gradient-to-r from-indigo-600 to-indigo-500 hover:from-indigo-700 hover:to-indigo-600 ${!canSubmit && !mutation.isPending ? "opacity-50" : ""}`}
            >
              {mutation.isPending
                ? "Working…"
                : mode === "sign_in"
