...
function generateReadmeFromSelection(
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Humanless AI](https://paperclip.ing) for more information.");
  lines.push("");
  lines.push("---");
  lines.push(`Exported from [Humanless AI](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
