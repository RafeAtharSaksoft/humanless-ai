...
export const AGENT_ORDER_UPDATED_EVENT = "humanless:agent-order-updated";
export const AGENT_SORT_MODE_UPDATED_EVENT = "humanless:agent-sort-mode-updated";
const AGENT_ORDER_STORAGE_PREFIX = "humanless.agentOrder";
const AGENT_SORT_MODE_STORAGE_PREFIX = "humanless.agentSortMode";
