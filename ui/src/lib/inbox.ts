...
export const DISMISSED_KEY = "humanless:inbox:dismissed";
export const READ_ITEMS_KEY = "humanless:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "humanless:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "humanless:inbox:issue-columns";
export const INBOX_NESTING_KEY = "humanless:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "humanless:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "humanless:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "humanless:inbox:collapsed-groups";
